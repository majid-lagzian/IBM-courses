...
The function that takes airline data as input and create 5 dataframes based on the grouping condition.
...
The function takes in airline data as an input and performs computation for creating charts and plots.
...
app.layout = html.Div(children=[ 
                                ...
                                html.Div([
                                    ...
                                    # Placing the charts next to each other using the division style
                                    ], style={'display':'flex'}),
...
def get_graph(chart, year, c1, c2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            # Computing required information for creating graphs
